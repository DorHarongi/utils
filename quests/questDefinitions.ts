...
export const QUESTS: Quest[] = [
  {
    ...
    description:
      "Upgrade your Center Building to level 2. This unlocks level 2 upgrades for all other buildings in your village!",
  ...
  },
  {
    ...
    description:
      "Upgrade your Wood Factory to level 2. Your wood production per worker will double from 0.25/sec to 0.5/sec!",
  ...
  },
  {
    ...
    description:
      "Upgrade your Stone Mine to level 2. Your stone production per worker will double from 0.25/sec to 0.5/sec!",
  ...
  },
  {
    ...
    description:
      "Upgrade your Crop Farm to level 2. Your crop production per worker will double from 0.25/sec to 0.5/sec!",
  ...
  },
  {
    ...
    description:
      "Upgrade your Quarters to level 2. Your max population increases from 100 to 250, allowing more workers and soldiers!",
  ...
  },
  {
    ...
    description:
      "Upgrade your Wood Warehouse to level 2. Your wood storage increases from 5,000 to 12,500!",
  ...
  },
  {
    ...
    description:
      "Upgrade your Stone Warehouse to level 2. Your stone storage increases from 5,000 to 12,500!",
  ...
  },
  {
    ...
    description:
      "Upgrade your Crop Warehouse to level 2. Your crop storage increases from 5,000 to 12,500!",
  ...
  },
  {
    ...
    description:
      "Upgrade your Center Building to level 3. This unlocks level 3 for all buildings - bigger upgrades ahead!",
  ...
  },
  {
    ...
    description:
      "Upgrade your Arsenal to level 3. This unlocks even more powerful troop types!",
    hint: "Click the Arsenal building",
  ...
  },
  {
    ...
    description:
      "Upgrade your Stable to level 2. The Stable unlocks spies that can scout enemy villages and gather valuable information.",
  ...
  },
  {
    ...
    description:
      "Join or create a clan! Team up with other players for raids, support, and glory! You'll need to upgrade your Embassy to level 3 first.",
